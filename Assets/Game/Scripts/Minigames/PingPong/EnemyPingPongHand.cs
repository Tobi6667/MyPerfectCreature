...
public class EnemyPingPongHand : BodyPartBase
{
    ...
    public override void Initialize()
    {
        ...
        opponentTarget = GameManager.Instance.ActiveBodyPart.gameObject.transform;
    }
    ...
    // -------------------------------------------------------------------------
    /*
    internal void SetRoundData(HandGameRoundData data)
    {
